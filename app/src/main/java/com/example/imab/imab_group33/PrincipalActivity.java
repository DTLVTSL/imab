...
/**
 * Created by daniel on 4/26/2017.
 */
...
public class PrincipalActivity extends AppCompatActivity implements View.OnCreateContextMenuListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent i = new Intent(view.getContext(), com.example.imab.imab_group33.Items_activity.class);
